...
const ModernTemplate: React.FC<ModernTemplateProps> = ({ resume, language }) => {
  ...
  return (
    <div className="p-8 bg-white min-h-full" style={{ fontFamily: 'Arial, sans-serif', fontSize: '10pt', lineHeight: '1.2' }}>
      ...
      <div className="text-center mb-6">
        ...
        <div className="flex flex-wrap justify-center gap-4 text-gray-700 mb-4" style={{ fontSize: '10pt' }}>
          {personalInfo.email && (
        ...
        {personalInfo.summary && (
          <p className="text-gray-700 text-justify max-w-4xl mx-auto" style={{ fontSize: '10pt', lineHeight: '1.3' }}>
            {personalInfo.summary}
          </p>
        )}
      </div>
              ...
              <div key={exp.id}>
                <div className="flex justify-between items-start mb-1">
                  <div>
                    ...
                    <p className="text-gray-700 font-semibold" style={{ fontSize: '10pt' }}>{exp.company}</p>
                  </div>
